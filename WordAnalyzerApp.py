...
pygame.display.set_caption('WordAnalyzer')
...
numbers = "1234567890"
numbers_result = " Numbers: None"
number_count_displayed = " Numbers in word: 0"
number_of_words_result = " Words: 0"
...
while running:
            ...
            if event.key == pygame.K_BACKSPACE:
                ...
                for letter in text:
                    ...
                    if letter in numbers:
                        number_count +=1
                        length +=1
                        numbers_found += letter
                    
                    if letter in space:
                        pass
                    
                    if letter in vowels or letter in consonants or letter in numbers or letter in space:
                        warning = ""
                        ...
                        warning = " ERROR: Only letters A-Z and numbers are allowed."
                ...
                number_count_displayed = f" Numbers in word: {number_count}"
                numbers_result = f" Numbers: {numbers_found}"
                number_of_words_result = f" Words: {words_count}"
    ...
    numbers_displayed = font.render(number_count_displayed, True, (255,255,255))
    numbers_result_displayed = font.render(numbers_result, True, (255, 255, 255))    
    words_count_displayed = font.render(number_of_words_result, True, (255,255,255))
    ...
    screen.blit (numbers_displayed, (10, 180))
    screen.blit(numbers_result_displayed, (10,200))
    screen.blit(words_count_displayed,(10,220))
    screen.blit(warning_text, (10, 280))
